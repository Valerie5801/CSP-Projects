...
int main(void){
    ...
    printf("\n Your rent cost is %.2f", pRent, "percent of  your income");
    printf("\n Your utility cost is %.2f", pUtilites, "percent of your income");
    printf("\n Your grocery cost is %.2f", pGroceries, "percent of your income");
    printf("\n Your transportation cost is %.2f", pTransportation, "percent of your income");
    return 0;
}